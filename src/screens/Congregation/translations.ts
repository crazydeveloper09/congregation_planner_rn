export const authTranslations = {
  pl: {
    ...
    forgotPasswordButtonText: "Zapomniałem hasło",
    ...
    specialLinkInstruction: "Specjalny link dostaniesz od administratora aplikacji z Twojego zboru. Jeśli Twój zbór nie używa aplikacji, a myślisz, że może się przydać, powiedz o tym któremuś ze starszych.",
    firstStepsInstruction: "Po pomyślnej weryfikacji i zalogowaniu kliknij Ustawienia -> Głosiciele i dodaj głosicieli z Twojego zboru.",
  ...
  en: {
    ...
    forgotPasswordButtonText: "I forgot the password",
    ...
    specialLinkInstruction: "You get special link from congregation admin. If your congregation does not use the app, but you think it can help, just tell some elder about it.",
    firstStepsInstruction: "After successful verification go to Settings -> Preachers and add preachers from your congregation.",
    elder: "Elders",
