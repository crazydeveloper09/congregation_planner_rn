...
const PreachersNewScreen: React.FC = () => {
    ...
    const [rolesItems, setRolesItems] = useState([
        ...
        {label: preacherTranslate.t("can_do_talk"), value: "can_do_talk", parent: "forms"},
        {label: preacherTranslate.t("can_do_watchtower"), value: "can_do_watchtower", parent: "forms"},
        {label: preacherTranslate.t("can_do_treasures"), value: "can_do_treasures", parent: "forms"},
        {label: preacherTranslate.t("can_do_exercise"), value: "can_do_exercise", parent: "forms"},
        {label: preacherTranslate.t("can_do_las"), value: "can_do_las", parent: "forms"},
