...
import { Provider as MeetingProvider } from './contexts/MeetingContext';
import { Provider as MinistryMeetingProvider } from './contexts/MinistryMeetingContext';
import { Provider as CartsScheduleProvider } from './contexts/CartsScheduleContext';
import { Provider as AudioVideoProvider } from './contexts/AudioVideoContext';
import { Provider as OrdinalsProvider } from './contexts/AttendantsContext';
import { Provider as PreachersProvider } from './contexts/PreachersContext';
import { Provider as MinistryGroupProvider } from './contexts/MinistryGroupContext';
import { Provider as SettingsProvider } from './contexts/SettingsContext';
import { Alert, StatusBar } from 'react-native';
import { useFonts } from 'expo-font';
import { navigationRef } from './RootNavigation';
import SwitchNavigator from './navigators/Switch';
import FlashMessage from 'react-native-flash-message';
import * as Calendar from 'expo-calendar';
import { useContext, useEffect, useState } from 'react';
import PreachersNavigator from './navigators/Preachers';
